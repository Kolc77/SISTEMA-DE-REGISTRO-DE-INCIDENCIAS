...
export class CorporacionesController {
  ...
  @Get()
  findAll() {
    return this.corporacionesService
      .findAll()
  ...
  // GET /corporaciones/:id - Obtener una corporacion especifica
  @Get(':id')
  ...
  // POST /corporaciones - Crear nueva corporacion
  @Post()
  ...
  // PUT /corporaciones/:id - Actualizar corporacion
  @Put(':id')
  update(
    ...
    return this.corporacionesService
      .update(id, data)
      .then((updated) => ({ ok: true, data: updated }));
  }
  ...
  // DELETE /corporaciones/:id - Eliminar corporacion de forma definitiva
  @Delete(':id')
